...
def home0(request):
    ...
    if request.method=='POST':
        ...
        print(lista_diario['cidade'])
        print(lista_total['tmp_max'])
...
def grafico(request):
    print(f'Lista {lista_total['tmp_max']}')
    lista_grafico=[]
